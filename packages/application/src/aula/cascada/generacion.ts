...
export function bloqueCorpus(ctx: ContextoCascada): BloqueSistema {
  ...
  const texto = [
    ...
    '2. Un indicador de evaluación solo lleva fuente "programa_estudio" si aparece abajo como indicador oficial; si lo propones tú, márcalo "ia_borrador".',
...
export const INSTR_UNIDAD = instruccion(
  [
    ...
    "- 'oa': incluye cada OA con su categoría y descripción VERBATIM del corpus.",
    "- 'indicadores_evaluacion': 1–3 por cada OA basal; usa fuente 'programa_estudio' solo si el indicador aparece como oficial, de lo contrario 'ia_borrador'.",
    "- 'contenidos': conceptuales, procedimentales y actitudinales coherentes con los OA.",
    "- 'actividades': situaciones de aprendizaje concretas y apropiadas al nivel.",
    "- 'tipo_evaluacion': incluye al menos diagnóstica, formativa y sumativa.",
