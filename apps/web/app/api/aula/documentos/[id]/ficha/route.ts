// GET /api/aula/documentos/[id]/ficha — genera y sirve la FICHA en .docx (o .pdf).
...
const log = crearLoggerHijo('web/documentos/ficha');
...
export async function GET(
  ...
  try {
    ...
    return responderError500(log, e, { id, formato }, 'GET /documentos/[id]/ficha falló');
  }
}
